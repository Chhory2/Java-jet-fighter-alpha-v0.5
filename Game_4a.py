...
bgmg=pygame.image.load("bg.jpg")
bgmg=pygame.transform.scale(bgmg,(988,1312))
win = pygame.display.set_mode((988,1312))
pygame.display.set_caption("Java jet fighter")
x = 200
y = 200
w = 25
h = 30
...
pygame.mixer.music.play(90000)
while not start :
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			run = False
	bgimg=pygame.image.load("bg.jpg")
	bgimg=pygame.transform.scale(bgimg,(988,1212))
	win.fill((0,0,0))
	win.blit(bgimg,(0,0))
	cur=pygame.mouse.get_pos()
	pygame.draw.rect(win, (0,0,225),(200,460,400,90))
...
# list of backgrounds
BACKGROUNDS_LIST = (
    'assets/sprites/background0.jpg',
    'assets/sprites/background1.jpg',
    'assets/sprites/background2.jpg',
    'assets/sprites/background3.jpg',
)

# list of pipes
PIPES_LIST = (
    'assets/sprites/pipe0.png',
    'assets/sprites/pipe1.png',
)
...
def main():
    ...
    # game over sprite
    IMAGES['gameover'] = pygame.image.load('assets/sprites/youredestroyed.png').convert_alpha()
    # message sprite for welcome screen
    IMAGES['message'] = pygame.image.load('assets/sprites/launch.png').convert_alpha()
    # base (ground) sprite
...
def mainGame(movementInfo):
    ...
    playerVelY = -10  # player's velocity along Y, default same as playerFlapped
    playerMaxVelY = 10  # max vel along Y, max descend speed
    playerMinVelY = -8  # min vel along Y, max ascend speed
    playerAccY = 1  # players downward accleration
    playerRot = 45  # player's rotation
    playerVelRot = 3.5  # angular speed
